...
# Forcer SQLite avant tout import backend (évite MariaDB dev local pendant les tests).
...
os.environ["AGENT_API_SECRET"] = _TEST_SECRET
os.environ["KORYMB_DB_ENGINE"] = "sqlite"
os.environ["ENV"] = "test"
