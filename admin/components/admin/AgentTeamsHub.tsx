                ...
                <li key={g.id}>
                  ...
                  >
                    <span className="flex items-center justify-between gap-2">
                      ...
                      <span className={`text-[10px] font-bold ${active ? "text-violet-100" : "text-slate-400"}`}>
                        {count}
                      </span>
                    </span>
                    <span className={`mt-0.5 block truncate text-[11px] ${active ? "text-violet-100" : "text-slate-500"}`}>
                      {g.is_system ? "Système · " : ""}
