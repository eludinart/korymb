...
export default function MissionGuidedPanel() {
  return (
    <Suspense fallback={<div className="p-6 text-center text-slate-500">Chargement du cadrage…</div>}>
      <MissionGuidedPanelInner />
    </Suspense>
  );
}
